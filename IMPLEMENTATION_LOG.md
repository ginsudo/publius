...
- No browser/Playwright test coverage. The verification was tsc + curl + DOM inspection; an end-to-end test against a stubbed `/api/ask` would close the gap and is a candidate slice if regressions appear.
